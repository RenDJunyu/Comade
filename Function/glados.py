...
cookie="koa:sess=eyJ1c2VySWQiOjE3OTI5MywiX2V4cGlyZSI6MTY4MzcyOTU0Mzc4MCwiX21heEFnZSI6MjU5MjAwMDAwMDB9; koa:sess.sig=C1JLGGzemDBjePFnPM4jzaCoy4k; _ga=GA1.2.1241755386.1657809833; _gid=GA1.2.1733378380.1657809833; _gat_gtag_UA_104464600_2=1; __cf_bm=TwK3CiEehjdfEp2NdgJr6._dG59K_8sZWhBNlk0hZfU-1657809833-0-AVRDP7eBTBGjeIb7swfoHM+tPZolAPf4OnkpndOnodzr4qFeZ5nJ3y/QQlmcLi/swlHQSjiQpE5NI01EB/8iO00LWQF8Bo+aVHrH04jnejL0natxNwR9ldGAcPnJ1bKVoA=="
header['cookie']=cookie
checkin = requests.post(url1,headers=header,data=json.dumps({'token': "glados.network"}))
state = requests.get(url2,headers={'accept':accept,'referer': referer,'user-agent':user2,'cookie': cookie})
print(re.findall(r"\"message\":\"[^\"]*\"",checkin.text))
